<template>
  <div id="serviceDemand">
    ...
    border-bottom: 2px solid #edf0f5;">
      <span>认证审核</span><span> > </span><span style="color: #777;">服务供应方</span>
    </p>
    <div class="tableWrap">
      <div class="tableBox">
        <div class="searchBar">
  ...
  export default {
    ...
    methods:{
      ...
      handleCheck(index, row) {
        var id = index;
        this.$router.push({ name:"serviceView",params:{ companyName: row.companyName,companyCode:row.companyCode}})
      },
      //类型判断
